  <?php require './database/client-view.php'; ?>
	...
	<h2><img style="width: 50px; padding-bottom: 10px; margin-right: 15px;" src="https://s3-ap-southeast-2.amazonaws.com/itac.technology/Web+Assets/meerkat.png" alt="">Welcome to the clan! :)</h2>
  ...
  '_blank'
    ...
    <div class="custom-control custom-checkbox">
      ...
      <div class="custom-control custom-checkbox"  style="margin-bottom: 50px;">
        ...
        <label class="custom-control-label" for="anti_virus">Anti-virus security protection | $59.95 per workstation per year</label>
      </div>
		</div>
